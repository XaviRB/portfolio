...
summary: "As an engineer automation is now a foundationaly part of SDLC, but also in robotics automation will be the next step for mankind for a prospering nation"
---
