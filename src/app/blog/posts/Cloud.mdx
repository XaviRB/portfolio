...
summary: "What is the cloud? The first thought that comes to mind is where my photos are stored, but it is much more than that. As an engineer I now understand that the could is the future of data as the share of information is invaluable. The cloud is a technology that is here to stay."
---
